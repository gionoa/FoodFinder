...
extension RestaurantsViewController: UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int { restaurantsViewModel.restaurantCount }
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        #warning("would move to separate UIView class to encapsulate/cleanup")
        ...
        #warning("Following values from sketch file")
        ...
        NSLayoutConstraint.activate([
            ...
            centerView.centerXAnchor.constraint(equalTo: headerView.centerXAnchor, constant: 207), // not sure why centerX without constant isn't working
